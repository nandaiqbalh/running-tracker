package com.nandaiqbalh.runningtracker.services
...
import com.nandaiqbalh.runningtracker.other.Constants.FASTEST_LOCATION_INTERVAL
import com.nandaiqbalh.runningtracker.other.Constants.LOCATION_UPDATE_INTERVAL
import com.nandaiqbalh.runningtracker.other.Constants.NOTIFICATION_CHANNEL_ID
import com.nandaiqbalh.runningtracker.other.Constants.NOTIFICATION_CHANNEL_NAME
import com.nandaiqbalh.runningtracker.other.Constants.NOTIFICATION_ID
import com.nandaiqbalh.runningtracker.other.Constants.TIMER_UPDATE_INTERVAL
				...
				result.locations.let { locations ->
					for(location in locations) {
						...
						timeRunInSeconds.observe(this@TrackingService, Observer {
								Timber.d(TrackingUtility.getFormattedStopWatchTime(it * 1000L))
						})
					}
				}
			}
